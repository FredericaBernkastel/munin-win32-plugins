...
if len(sys.argv) == 2:
	if sys.argv[1] == "config":
		...
		print("graph_title Throughput per device")
		print("graph_args --base 1024")
		print("graph_vlabel Bytes/${graph_period} read (-) / write (+)")
	...
	if sys.argv[1] == "name":
		print("diskstats_throughput")

if len(sys.argv) == 1:
	for disk in counters:
		DeviceId = disk.lower()
		print(DeviceId + "_read.value " + str(counters[disk].read_bytes))
		print(DeviceId + "_write.value " + str(counters[disk].write_bytes))
	print(".")